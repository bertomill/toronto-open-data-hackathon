...
export default function DataDispensations({ data }: DataDispensationsProps) {
  ...
  const revenueVsExpenses = useMemo(() => {
    ...
    yearData.forEach((row) => {
      const amountStr = row.Amount.replace(/[$,]/g, "") // Remove $ and commas
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-gray-600">
              Budget allocations and distributions across Toronto&apos;s
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {new Set(yearData.map((d) => d.Program)).size}
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${
                          (item.amount / programSummary[0].amount) * 100
                        }%`,
                      }}
                    />
                  </div>
          ...
          <div className="text-center">
            <div
              className={`text-3xl font-bold mb-2 ${
                revenueVsExpenses.totalRevenue -
                  revenueVsExpenses.totalExpenses >=
                0
                  ? "text-green-600"
                  : "text-red-600"
              }`}
